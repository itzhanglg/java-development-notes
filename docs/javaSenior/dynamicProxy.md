> 原文链接：[代理模式详解](https://snailclimb.gitee.io/javaguide/#/docs/java/basic/java-proxy)
>
> 推荐链接：
>
...
![Understanding the Proxy Design Pattern | by Mithun Sasidharan | Medium](https://gitee.com/itzlg/mypictures/raw/master/img/1*DjWCgTFm-xqbhbNQVsaWQw.png)
